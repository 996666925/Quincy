...
use egui_glow::glow;
use egui_tiles::{Container, Linear, SimplificationOptions};
...
impl GlutinWindowContext {
    ...
    unsafe fn new(event_loop: &winit::event_loop::EventLoopWindowTarget<UserEvent>) -> Self {
        ...
        let winit_window_builder = winit::window::WindowBuilder::new()
            ...
            .with_title("标题") // Keep hidden until we've painted something. See https://github.com/emilk/egui/pull/2279
            .with_visible(false);
